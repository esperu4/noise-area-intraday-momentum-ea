...
## Unreleased — cTrader phase

- Added shared Noise Area mathematical specification.
...
- Migrated both Pine strategy variants to Pine v6 and replaced the unavailable `ta.sum` call with an explicit rolling-sum helper.
